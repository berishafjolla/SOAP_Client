namespace WebServiceStudio
{
    ...
    public class MainForm : Form
    {
        ...
        private static string MiniHelpText = "\r\n        Soap Klienti eshte vegel per konsumimin e Soap Ueb sherbimeve permes WSDL-se ose URI ku ndodhet Ueb sherbimi.";
        ...
        private void CopyToClipboard(TreeNodeProperty tnp)
        {
            ...
            {
                throw new Exception("Nuk mund te kopjohet nga ketu");
            }
        ...
        private MethodProperty GetCurrentMethodProperty()
        {
            ...
            {
                MessageBox.Show(this, "Zgjedh metoden per ekzekutim");
                return null;
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.labelEndPointUrl.Text = "URI-ja e WSDL-se";
            ...
            this.menuItemSaveAll.Text = "Ruaj krejt fajllat...";
            ...
            try
            {
                ...
                this.openWsdlDialog.Title = "Hap WSDL";
            ...
            this.toolBarButton1.Text = "Hap Wsdl...";
            this.toolBarButton1.ToolTipText = "Hap fajllin WSDL";
            ...
            this.buttonBrowseFile.Text = "Shfleto Wsdl ...";
            ...
            this.labelInputValue.Text = "Vlera";
            ...
            this.labelOutputValue.Text = "Vlera";
            ...
            this.tabPageMessage.Text = "Mesazhet";
            this.richMessage.Font = Configuration.MasterConfig.UiSettings.MessageFont;
            ...
            this.tabPageRaw.Controls.AddRange(new Control[] { this.splitterRaw, this.panelRightRaw });
        ...
        {
            MessageBox.Show(this, "SOAP Klienti per konsumim te Ueb sherbimeve SOAP");
        }
        ...
        private void treeInputMenuPaste_Click(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Jovalid tipi");
            }
